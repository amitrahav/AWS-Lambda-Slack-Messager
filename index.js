...
exports.handler = (event, context, callback) => {
    ...
    const CPurl = event["CodePipeline.job"].data.actionConfiguration.configuration.UserParameters; 
		...
		let deployUrl = CPurl || process.env.URL || 'http://ec2-someIP.compute.amazonaws.com/';
